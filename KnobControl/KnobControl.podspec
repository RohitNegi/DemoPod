...
spec.homepage     = "http://raywenderlich.com"
  ...
  # Or just: spec.author    = "Rohit Negi"
  # spec.authors            = { "Rohit Negi" => "rohitnegi017@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Rohit Negi"
  ...
  spec.source       = { :git => 'https://github.com/RohitNegi/DemoPod.git', :tag=>"1.0.0" }
